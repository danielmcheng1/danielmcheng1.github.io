...
def respond(input):
    ...
    #Python 3--map object returns reference to map instead of list so we need to return a list instead 
    return eliza.interact(input, rules_list, [str.upper() for str in default_responses])

...
def convertPOS(word, from_pos, to_pos):    
    ...
    #Python 3--update s.lemmas and s.name to be method calls instead of attributes
    ...
    #Python 3--update l.sysnet and .name to be method calls instead of attributes
    ...
    return [(word, 0.0)] if result == [] else result 
